...
try:
	while True:
		inFile = open('/home/DatiTB/DTC/RI_ALL.txt', 'r')
		s = inFile.readline()
		a = s.split('\t')
		run = str(a[1].replace('\n', ''))
		inFile.close()

		outFile = open('/home/DatiTB/DTC/slowTemp_ROSSO_dump','a')
		...
		if (WP_set == 34) : WP_hex = WP_hex_34
		elif (WP_set == 30) : WP_hex = WP_hex_30
		elif (WP_set == 24) : WP_hex = WP_hex_24

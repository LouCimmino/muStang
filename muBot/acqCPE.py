...
while True : 
	...
	while True:
		...
		for mux in range(5):
			...
			inputF.close()
		outputF = open('/home/DatiTB/DTC/MUXtemp_' + sys.argv[3], 'w')
		...
		while True:
			...
			arg = ['cp', 'cTrigger_Counts', '/home/DatiTB/' + sys.argv[3] + '/cTrigger_Counts']
			subprocess.call(arg)
			...
			for Sk in skList :
				...
				argv = ['./ReadMaster_count', sys.argv[3]]
				subprocess.call(argv)
				inp = open('/home/DatiTB/' + sys.argv[3] + '/SlaveCounts', 'r')
				outp = open('/home/DatiTB/' + sys.argv[3] + '/Counts_LAB', 'a')
				...
				argv = ["rm", "/home/DatiTB/" + sys.argv[3] + "/SlaveCounts"]
				subprocess.call(argv)
			...
			while(pedCounter < int(numPeds)):
				...
				arg = ['./ReadPed', str(pedEvts), skList[0], skList[1], skList[2], skList[3], skList[4], skList[5], skList[6], skList[7], skList[8], skList[9], skList[10], skList[11], skList[12], skList[13], skList[14], skList[15], sys.argv[3]]
				subprocess.call(arg)

				outputF = open('/home/DatiTB/' + sys.argv[3] + '/pedData', 'a')
				outputF.write(str(int(round(time.time()*1000))))
				outputF.close()
			...
			while(adcCounter < int(numEvts)):
				...
				arg = ['./ReadSlave', str(evts) , skList[0], skList[1], skList[2], skList[3], skList[4], skList[5], skList[6], skList[7], skList[8], skList[9], skList[10], skList[11], skList[12], skList[13], skList[14], skList[15], sys.argv[3]]
				subprocess.call(arg)

				outputF = open('/home/DatiTB/' + sys.argv[3] + '/slaveData', 'a')
				outputF.write(str(int(round(time.time()*1000))))
				outputF.close()
			
				arg = ['mv', '/home/DatiTB/' + sys.argv[3] + '/slaveData', '/home/DatiTB/' + sys.argv[3] + '/slaveData_evts' + str(evts*int(numEvts)) + '_run' + str(runCounter) + '_sr' + str(adcCounter)]
				subprocess.call(arg)
